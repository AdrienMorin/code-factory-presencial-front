    ...
    <div className="flex flex-row gap-4">
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="flex-1">
            <div className="flex flex-col items-center">
              <img src="/distribucion1.png" alt="Distribución 1" className="w-full h-auto" />
              <button
                type="button"
                onClick={() => field.onChange({ target: { value: 'distribucion1' } })}
                className={`mt-2 w-6 h-6 rounded-full border-2 ${field.value === 'distribucion1' ? 'bg-blue-500 border-black-500' : 'bg-white border-gray-300'} flex items-center justify-center`}
              >
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="flex-1">
            <div className="flex flex-col items-center">
              <img src="/distribucion2.png" alt="Distribución 2" className="w-full h-auto" />
              <button
                type="button"
                onClick={() => field.onChange({ target: { value: 'distribucion2' } })}
                className={`mt-2 w-6 h-6 rounded-full border-2 ${field.value === 'distribucion2' ? 'bg-blue-500 border-black-500' : 'bg-white border-gray-300'} flex items-center justify-center`}
              >
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="flex-1">
            <div className="flex flex-col items-center">
              <img src="/distribucion3.png" alt="Distribución 3" className="w-full h-auto" />
              <button
                type="button"
                onClick={() => field.onChange({ target: { value: 'distribucion3' } })}
                className={`mt-2 w-6 h-6 rounded-full border-2 ${field.value === 'distribucion3' ? 'bg-blue-500 border-black-500' : 'bg-white border-gray-300'} flex items-center justify-center`}
              >
      ...
      <AlertDialog>
        <AlertDialogTrigger asChild>
          <Button type="submit" className="mt-4 bg-blue-500 text-white border border-blue-500 rounded-md px-4 py-2 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300">
            Registrar Aerovane
          </Button>
        </AlertDialogTrigger>
        <AlertDialogContent>
